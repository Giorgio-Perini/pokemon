...
def sbusto():
    pacchetto = []
    punti_guadagnati = 0
    for i in range(5):                  #prende le chiavi del dizionario e le usa come probabilità
                                                                        # prende i valori del dizionario 
        rarita_scelta = random.choices(list(probabilita_rarita.keys()),weights=probabilita_rarita.values(),k=1)[0]
                #prende una rarità a caso in base alla probabilità
